...
> 👋 **Новичок?** Начни с единого [онбординг-документа](../ONBOARDING.md) — он связно проводит по проекту и ссылается на нужные заметки. Затем держи под рукой [навигатор «когда что применять»](100-newcomer-decision-guide.md).
